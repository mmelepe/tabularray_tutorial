% Changing the colors from the other tutorial but too lazy to change the names
\definecolor{tblblue}{HTML}{FCAD38}
\definecolor{tblcyan}{HTML}{EB7F31}
...
\begin{tikzpicture}[remember picture,overlay]
	...
	at ([xshift=2.5cm,yshift=12cm] current page.south west)
	{
		...
		Longer, beginner-friendly version: \LongVersion
	};
\end{tikzpicture}
